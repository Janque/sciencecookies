...
<html lang="es">
  <head>
    ...
    <meta name="description" content="¿Tienes alguna sugerencia o duda? ¿Quieres reportar un fallo? Aquí puedes hacerlo."/>
    <link rel="canonical" href="https://sciencecookies.net/contacto"/>
    <link rel="shortcut icon" href="img/logoT.svg">
    <title>Science Cookies - Contacto</title>
  ...
  <body>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="mdlRgsL">Debes iniciar sesión o regístrarte para continuar</h5>
          </div>
      ...
      <div class="row justify-content-around">
        ...
        <div class="col-12 col-sm-9 col-md-6 col-xl-7 py-md-3 pl-md-3">
          ...
          <div class="container-fluid justify-content-center">
            <h3 class="text-center">Envíanos un mensaje</h3><br>
            <p>Si tienes alguna sugerencia, comentario o quieres reportar un fallo, puedes hacerlo aquí.</p><br>
            <form id="frmCont">
              <div class="form-group row">
                <label for="inEmail" class="col-sm-2 col-form-label">Email</label>
                <div class="col-sm-10">
                  <input type="text" readonly class="form-control-plaintext text-light" id="inEmail" value="">
                </div>
              </div>
              <div class="form-group row">
                <label for="inSubj" class="col-sm-2 col-form-label">Asunto</label>
                <div class="col-sm-10">
                  <select id="inSubj" class="form-control" required>
                    <option value="">Escoge...</option>
                    <option value="Sugerir una galleta" id="inOsuger">Sugerir una galleta</option>
                    <option value="Reportar un fallo" id="inOfallo">Reportar un fallo</option>
                    <option value="Sobre los Términos de Servicio" id="inOtos">Sobre los Términos de Servicio</option>
                    <option value="Sobre la Política de Privacidad" id="inOpriv">Sobre la Política de Privacidad</option>
                    <option value="Otro" id="inOotro">Otro</option>
                  </select>
                </div>
              </div>
              <div class="form-group row">
                <label for="inText" class="col-sm-2 col-form-label">Mensaje</label>
                <div class="col-sm-10">
                  <textarea type="text" class="form-control" id="inText" required></textarea>
                </div>
              </div>
              <div class="form-group d-flex">
                <div class="flex-grow-1">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="inAcpt" required>
                    <label class="form-check-label" for="inAcpt">Estoy de acuerdo con los <a href="docs/tos" class="text-warning">Términos de servicio</a> y la <a href="docs/privacidad" class="text-warning">Política de privacidad</a></label>
                  </div>
                </div>
                <div class="">
                  <button class="btn btn-outline-success px-4 px-sm-5 px-md-3 px-lg-5" type="submit">Enviar</button>
                </div>
              </div>
            </form>
          </div>
    ...
    <script src="js/contApp.js"></script>
