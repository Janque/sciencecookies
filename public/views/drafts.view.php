...
<html lang="es">
  <head>
    ...
    <meta name="description" content="Revisa y administra tus borradores"/>
    <link rel="canonical" href="https://sciencecookies.net/drafts"/>
    <link rel="shortcut icon" href="img/logoT.svg">
    <title>Science Cookies - Borradores</title>
  ...
  <body>
    ...
    <div class="modal fade" id="mdlPlus" tabindex="-1" aria-labelledby="mdlPlusL" aria-hidden="true">
      <div id="alrtPlusContainer"></div>
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="mdlPlusL">Crear una nueva galleta</h5>
            <button id="btnCanPlus1" type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form id="frmPlus">
              <div class="form-group">
                <label for="inTitle">Título de la galleta</label>
                <input class="form-control" type="text" placeholder="Nueva galleta" id="inTitle" required>
              </div>
              <div class="form-group">
                <label for="inFile">Nombre del archivo</label>
                <input class="form-control" type="text" placeholder="nueva-galleta" id="inFile" required>
              </div>
              <div class="dropdown-divider"></div>
              <button id="btnPlusConf" type="submit" class="btn btn-primary btn-block">Crear</button>
              <div class="progress d-none" id="barCont">
                <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%" id="bar"></div>
              </div>
            </form>
          </div>
          <div class="modal-footer">
            <button id="btnCanPlus0" type="button" class="btn btn-secondary btn-block" data-dismiss="modal">Cancelar</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="tbar tbar-right btn-toolbar mb-3" role="toolbar">
      <div class="btn-group-vertical mr-2 btn-group-lg" role="group">
        <button type="button" class="btn btn-scckie" id="btnPlus"><i class="fas fa-plus"></i></button>
      </div>
    </div>
    ...
    <div class="container-fluid text-white" style="background-color: black;background-image: url('img/fondo1.jpg');background-position: center top;background-attachment: fixed;">
      <div class="row justify-content-around">
        ...
        <div class="col-12 col-sm-9 col-md-6 col-xl-7 py-md-3 pl-md-3">
          ...
          <div class="container-fluid mb-2 rounded-lg p-3" style="background-color:rebeccapurple;">
              ...
              <div class="input-group">
                ...
                <div class="input-group-append" id="frmBtns">
                  <select class="custom-select rounded-0" id="inOrd">
                    <option value="created" id="inSrchOrd0">Creación</option>
                    <option value="published" id="inSrchOrd1">Publicación</option>
                    <option value="ledit" id="inSrchOrd2">Edición</option>
                    <option value="pop" id="inSrchOrd3">Popularidad</option>
                  </select>
                  <select class="custom-select rounded-0" id="inDir">
                    <option value="desc" id="inSrchDir0">Decendente</option>
                    <option value="asc" id="inSrchDir1">Acendente</option>
                  </select>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-1 row-cols-lg-2 row-cols-xl-3" id="crdContainer">
              <!--Cards-->
            </div>
