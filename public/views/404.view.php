...
<html lang="es">
  <head>
    ...
    <title>Science Cookies - Página no encontrada</title>
      ...
      <div class="row justify-content-around">
        ...
        <div class="col-12 col-sm-9 col-md-6 col-xl-7 py-md-3 pl-md-3">
          ...
          <div class="container-fluid mb-2 rounded-lg p-3" style="background-color:rebeccapurple;">
            ...
            <p>El sitio que buscas no esta disponible.</p>
            <p>Es posible que sea porque el sitio está en construcción o porque escribiste mal el URL, por favor revisa el URL o intenta de nuevo más tarde.</p>
            <p class="text-center"><a class="btn btn-dark mx-2 my-1" href="https://sciencecookies.net">Volver al inicio</a></p>
