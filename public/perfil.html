...
<html lang="es">
  <head>
    ...
    <link rel="canonical" href="https://sciencecookies.net/perfil"/>
    <link rel="shortcut icon" href="../../img/logoT.svg">
    <title>Science Cookies - Perfíl</title>
  ...
  <body>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="window.location.href='https://sciencecookies.net'">Cancelar</button>
          </div>
        </div>
      </div>
    </div>
    <!--Change nick mdl-->
    <div class="modal fade" id="mdlCngNck" tabindex="-1" role="dialog" aria-labelledby="mdlCngNckL" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="mdlCngNckL">Cambia tu nombre de usuario</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <form id="frmChngNk">
                  <div class="form-group">
                    <label for="inNewNck">Nuevo nombre de usuario</label>
                    <input type="text" class="form-control" id="inNewNck" placeholder="Nuevo nombre de usuario" maxlength="20" required>
                  </div>
                  <button type="submit" class="btn btn-primary btn-block">Confirmar</button>
                </form>
            </div>
            <div class="modal-footer">
            <button type="button" class="btn btn-secondary btn-block" data-dismiss="modal" onclick="resetFrm();">Cancelar</button>
            </div>
        </div>
      </div>
    </div>
    <!--Change prflPic mdl-->
    <div class="modal fade" id="mdlCngPP" tabindex="-1" role="dialog" aria-labelledby="mdlCngPPL" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            <h5 class="modal-title" id="mdlCngPPL">Sube una nueva foto de perfíl</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
              <div class="progress d-none" id="prBar">
                <div class="progress-bar progress-bar-striped bg-info progress-bar-animated" role="progressbar" aria-valuemin="0" aria-valuemax="100" id="prBarDis">Subiendo...</div>
              </div>
              <div class="row mb-3 w-100 py-0 justify-content-center mx-auto"><img id="preVIn" src="" alt="" class="w-50 m-0"></div>
              <form id="frmChngPP">
                <div class="custom-file mb-5">
                  <input type="file" class="custom-file-input" id="inNwPP" required>
                  <label class="custom-file-label" for="inNwPP" data-browse="Elegir" id="inNwPPL">Elige una imagen</label>
                  <small>Tamaño máximo: 5Mb.</small><br>
                  <small>Tamaño máximo del nombre: 32 caractéres.</small><br>
                  <small>Tipos de archivo aceptados: png, jpg, tiff, webp.</small>
                </div>
                <button type="submit" class="btn btn-primary btn-block" id="btnCnfNwPP">Subir</button>
              </form>
            </div>
            <div class="modal-footer">
            <button type="button" class="btn btn-secondary btn-block" data-dismiss="modal" onclick="resetFrm();" id="btnCanNwPP">Cancelar</button>
            </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-12 col-sm-9 col-md-6 col-xl-7 py-md-3 pl-md-3">
          ...
          <ul class="nav nav-tabs">
            <li class="nav-item mx-lg-1 mx-0">
              <a class="nav-link text-decoration-none btn-outline-light" onclick="shwCrds(1);" id="navBtnPrfl">Mi perfíl</a>
            </li>
            <li class="nav-item mx-lg-1 mx-0">
              <a class="nav-link text-decoration-none btn-outline-light" onclick="shwCrds(2);" id="navBtnFav">Mis favoritos</a>
            </li>
            <li class="nav-item ml-lg-1 mr-lg-auto mx-0">
              <a class="nav-link text-decoration-none btn-outline-light" onclick="shwCrds(3);" id="navBtnLike">Mis me gusta</a>
            </li>
            <li class="nav-item mx-lg-1 mx-0">
              <a class="nav-link text-decoration-none btn-outline-light" onclick="shwCrds(0);" id="navBtnPref"><i class="fas fa-user-cog"></i></a>
            </li>
          </ul>
          <div class="container-fluid px-2">
            <div class="card text-light border-light bg-transparent mt-2 d-none" id="crdPrfl">
              <ul class="list-group list-group-flush">
                <li class="list-group-item text-light border-light bg-transparent d-flex">
                  <img src="" alt="Foto de perfil" class="rounded" height="150" id="disPP">
                  <button type="button" class="btn btn-link align-self-end" data-toggle="modal" data-target="#mdlCngPP">(Cambiar)</button>
                </li>
                ...
                <li class="list-group-item text-light border-light bg-transparent">
                  <div class="container"><div class="row">
                    <div class="col col-4">
                      ...
                      <button type="button" class="btn btn-link" data-toggle="modal" data-target="#mdlCngNck">(Cambiar)</button>
                    </div>
            ...
            <div class="card text-light border-light bg-transparent mt-2 d-none" id="crdPref">
              <form id="frmPref">
                <ul class="list-group list-group-flush">
                  <li class="list-group-item text-light border-light bg-transparent">
                    <div class="custom-control custom-switch">
                      <input type="checkbox" class="custom-control-input" id="inPubPrfl">
                      <label class="custom-control-label" for="inPubPrfl">Otras personas pueden ver mi perfíl</label>
                    </div>
                    <div class="custom-control custom-switch">
                      <input type="checkbox" class="custom-control-input text-success" id="inPubEmail">
                      <label class="custom-control-label" for="inPubEmail">Otras personas pueden ver mi correo electrónico</label>
                    </div>
                    <div class="custom-control custom-switch">
                      <input type="checkbox" class="custom-control-input text-success" id="inPubFL">
                      <label class="custom-control-label" for="inPubFL">Otras personas pueden ver mis likes y favoritos</label>
                    </div>
                  </li>
                  <li class="list-group-item text-light border-light bg-transparent">
                    <div class="custom-control custom-switch">
                      <input type="checkbox" class="custom-control-input text-success" id="inNews">
                      <label class="custom-control-label" for="inNews">Recibir notificaciones por correo electrónico</label>
                    </div>
                  </li>
                  <li class="list-group-item text-light border-light bg-transparent">
                    <div class="row justify-content-end">
                      <div class="col-auto mr-2 p-0">
                        <button class="btn btn-secondary" type="button" id="btnCanPref" onclick="shwPref();">Descartar</button>
                      </div>
                      <div class="col-auto mr-2 p-0">
                        <button class="btn btn-success" id="btnCnfPref">Guardar cambios</button>
                      </div>  
                    </div>
                  </li>
                </ul>
    ...
    <script src="js/prflApp.js"></script>
