...
},{"./bundle-url":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"styles/edit.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/edit.js":[function(require,module,exports) {
"use strict";
...
window.loaded = function loaded() {
      ...
      if (err.code == 'storage/object-not-found') {
        ref.put(newMedia).on('state_changed', function progress(snap) {
          ...
          ref.getDownloadURL().then(medUrl => {
            ...
            fillMed();
            $('#mdlAddMed').modal('hide');
            if (addFrom == 0) $('#mdlMedMan').modal('show');else $('#mdlMedCho').modal('show');
          }).catch(err => {
            console.log(err);
          });
        });
  ...
  document.getElementById("frmAddMed").addEventListener("submit", function (event) {
    ...
    if (newMedSrc == "home") addMed(0);else addExtMed();
  });
};
    ...
    if (item.type != 'ref') {
      ...
      btnEdit.onclick = function () {
        ...
        if (document.getElementById('tagLstSave').innerText == "Se han guardado todos los cambios") {
          ...
          if (minutes > 0) {
            if (minutes > 59) document.getElementById('tagLstSave').innerText = "Guardado hace " + Math.floor(minutes / 60) + " horas";else document.getElementById('tagLstSave').innerText = "Guardado hace " + minutes + " minutos";
    ...
    if (item.type == 'head') {
      ...
      in1.oninput = function () {
        ...
        if (Number(in1.value) > 0) {
          in0.setAttribute('placeholder', 'Subtítulo');
          in0.removeAttribute('readonly');
          if (Number(item.title) == 2) subt.innerHTML = '<br>';else subt.innerHTML = "";
          h = document.createElement('h' + item.title);
      ...
      in0.onchange = function () {
        ...
        if (convUrl.length == 11) convUrl = "https://www.youtube.com/embed/" + convUrl;else {
          let part,
              i = 1;
...
},{"../styles/edit.scss":"styles/edit.scss"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/edit.js"], null)
//# sourceMappingURL=/edit.6da2ba10.js.map