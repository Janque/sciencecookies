...
function shwSsnBtns(ac){
    if(ac){
        ...
        document.getElementById('ppCom').setAttribute('onerror',"this.src='../../img/nopp.png'");
        ...
        document.getElementById('ppCom').setAttribute('onerror',"");
        document.getElementById('ppCom').src='';
...
window.addEventListener("load",function(){
    ...
    cookRef.on('value',snap=>{
        if(snap.val()){
            let span=document.getElementById('favCount');
            if(span==null||span==undefined){
                span=document.createElement('span');
                span.id="favCount";
                span.classList.add('badge');
                span.classList.add('badge-dark');
                span.innerText=snap.val().favs;
                document.getElementById('btnFav').innerHTML=document.getElementById('btnFav').innerHTML+' ';
                document.getElementById('btnFav').appendChild(span);
            }else{
                span.innerText=snap.val().favs;
            }
            span=document.getElementById('likeCount');
            if(span==null||span==undefined){
                span=document.createElement('span');
                span.id="likeCount";
                span.classList.add('badge');
                span.classList.add('badge-dark');
                span.innerText=snap.val().likes;
                document.getElementById('btnLike').innerHTML=document.getElementById('btnLike').innerHTML+' ';
                document.getElementById('btnLike').appendChild(span);
            }else{
                span.innerText=snap.val().likes;
            }
        }
