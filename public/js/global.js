...
var ddd = new Date();
ddd.setTime(ddd.getTime() + 5 * 60 * 1000); //document.cookie = "firebase-language-override=en; expires=" + ddd.toUTCString();
...
window.addEventListener("load", function () {
  ...
  document.getElementById('changeLang').onclick = function () {
    ...
    if (window.lang = "es") {
      ...
      document.cookie = "firebase-language-override="; //document.cookie = "firebase-language-override=en; expires=" + dddd.toUTCString();
    } else if (window.lang = "en") {
      window.lang = "es";
      let dddd = new Date();
      dddd.setTime(dddd.getTime() + 5 * 60 * 1000);
      document.cookie = "firebase-language-override="; //document.cookie = "firebase-language-override=es; expires=" + dddd.toUTCString();
    }
  };
...
var defDiacs = [{
  'corr': 'A',
  'lt': '\u0041\u24B6\uFF21\u00C0\u00C1\u00C2\u1EA6\u1EA4\u1EAA\u1EA8\u00C3\u0100\u0102\u1EB0\u1EAE\u1EB4\u1EB2\u0226\u01E0\u00C4\u01DE\u1EA2\u00C5\u01FA\u01CD\u0200\u0202\u1EA0\u1EAC\u1EB6\u1E00\u0104\u023A\u2C6F'
}, {
  'corr': 'AA',
  'lt': '\uA732'
}, {
  ...
  'corr': 'E',
  'lt': '\u0045\u24BA\uFF25\u00C8\u00C9\u00CA\u1EC0\u1EBE\u1EC4\u1EC2\u1EBC\u0112\u1E14\u1E16\u0114\u0116\u00CB\u1EBA\u011A\u0204\u0206\u1EB8\u1EC6\u0228\u1E1C\u0118\u1E18\u1E1A\u0190\u018E'
}, {
  'corr': 'F',
  'lt': '\u0046\u24BB\uFF26\u1E1E\u0191\uA77B'
}, {
  ...
  'corr': 'O',
  'lt': '\u004F\u24C4\uFF2F\u00D2\u00D3\u00D4\u1ED2\u1ED0\u1ED6\u1ED4\u00D5\u1E4C\u022C\u1E4E\u014C\u1E50\u1E52\u014E\u022E\u0230\u00D6\u022A\u1ECE\u0150\u01D1\u020C\u020E\u01A0\u1EDC\u1EDA\u1EE0\u1EDE\u1EE2\u1ECC\u1ED8\u01EA\u01EC\u00D8\u01FE\u0186\u019F\uA74A\uA74C'
}, {
  'corr': 'OI',
  'lt': '\u01A2'
}, {
  ...
  'corr': 'U',
  'lt': '\u0055\u24CA\uFF35\u00D9\u00DA\u00DB\u0168\u1E78\u016A\u1E7A\u016C\u00DC\u01DB\u01D7\u01D5\u01D9\u1EE6\u016E\u0170\u01D3\u0214\u0216\u01AF\u1EEA\u1EE8\u1EEE\u1EEC\u1EF0\u1EE4\u1E72\u0172\u1E76\u1E74\u0244'
}, {
  'corr': 'V',
  'lt': '\u0056\u24CB\uFF36\u1E7C\u1E7E\u01B2\uA75E\u0245'
}, {
  ...
  'corr': 'a',
  'lt': '\u0061\u24D0\uFF41\u1E9A\u00E0\u00E1\u00E2\u1EA7\u1EA5\u1EAB\u1EA9\u00E3\u0101\u0103\u1EB1\u1EAF\u1EB5\u1EB3\u0227\u01E1\u00E4\u01DF\u1EA3\u00E5\u01FB\u01CE\u0201\u0203\u1EA1\u1EAD\u1EB7\u1E01\u0105\u2C65\u0250'
}, {
  'corr': 'aa',
  'lt': '\uA733'
}, {
  ...
  'corr': 'e',
  'lt': '\u0065\u24D4\uFF45\u00E8\u00E9\u00EA\u1EC1\u1EBF\u1EC5\u1EC3\u1EBD\u0113\u1E15\u1E17\u0115\u0117\u00EB\u1EBB\u011B\u0205\u0207\u1EB9\u1EC7\u0229\u1E1D\u0119\u1E19\u1E1B\u0247\u025B\u01DD'
}, {
  'corr': 'f',
  'lt': '\u0066\u24D5\uFF46\u1E1F\u0192\uA77C'
}, {
  ...
  'corr': 'n',
  'lt': '\u006E\u24DD\uFF4E\u01F9\u0144\u00F1\u1E45\u0148\u1E47\u0146\u1E4B\u1E49\u019E\u0272\u0149\uA791\uA7A5'
}, {
  'corr': 'nj',
  'lt': '\u01CC'
}, {
  'corr': 'o',
  'lt': '\u006F\u24DE\uFF4F\u00F2\u00F3\u00F4\u1ED3\u1ED1\u1ED7\u1ED5\u00F5\u1E4D\u022D\u1E4F\u014D\u1E51\u1E53\u014F\u022F\u0231\u00F6\u022B\u1ECF\u0151\u01D2\u020D\u020F\u01A1\u1EDD\u1EDB\u1EE1\u1EDF\u1EE3\u1ECD\u1ED9\u01EB\u01ED\u00F8\u01FF\u0254\uA74B\uA74D\u0275'
}, {
  'corr': 'oi',
  'lt': '\u01A3'
}, {
