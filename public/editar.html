...
<head>
  ...
  <title>Science Cookies - Editar</title>
...
<body>
  ...
  <!--Add section modal-->
  <div class="modal fade" id="mdlPlusSect" tabindex="-1" aria-labelledby="mdlPlusSectL" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="mdlPlusSectL">Añadir una sección</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <div class="d-flex flex-wrap">
            <button class="btn btn-scckie m-2" onclick="plusSect('parra');" data-dismiss="modal">Párrafo</button>
            <button class="btn btn-scckie m-2" onclick="plusSect('html');" data-dismiss="modal">HTML</button>
            <button class="btn btn-scckie m-2" onclick="plusSect('youtube');" data-dismiss="modal">Youtube</button>
            <button class="btn btn-scckie m-2" onclick="plusSect('medSimple');" data-dismiss="modal">Multimedia</button>
          </div>
          <!--Add more@#-->
        </div>
        <div class="modal-footer">
  ...
  <!--Manage media modal-->
  <div class="modal fade" id="mdlMedMan" tabindex="-1" aria-labelledby="mdlMedManL" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="mdlMedManL">Administra las imágenes</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <div class="row row-cols-1 row-cols-md-3" id="contMedMan">
            <div class="col mb-4">
              <div class="card text-dark bg-light h-100 cardBorder" style="border-color: #343a40;">
                <a type="button" data-toggle="modal" data-target="#mdlAddMed" data-dismiss="modal" aria-label="Close"
                  class="text-decoration-none text-dark h-100 d-flex align-items-center justify-content-center"
                  onclick="addFrom=0;">
  ...
  <!--Choose media modal-->
  <div class="modal fade" id="mdlMedCho" tabindex="-1" aria-labelledby="mdlMedChoL" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="mdlMedChoL">Administra las imágenes</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <div class="row row-cols-1 row-cols-md-3" id="contMedCho">
            <div class="col mb-4">
              <div class="card text-dark bg-light h-100 cardBorder" style="border-color: #343a40;">
                <a type="button" data-toggle="modal" data-target="#mdlAddMed" data-dismiss="modal" aria-label="Close"
                  class="text-decoration-none text-dark h-100 d-flex align-items-center justify-content-center"
  ...
  <!--Add media modal-->
  <div class="modal fade" id="mdlAddMed" tabindex="-1" role="dialog" aria-labelledby="mdlAddMedL" aria-hidden="true"
    data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="mdlAddMedL">Escoge un archivo multimedia para añadir a la galleta</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="btnCanNewMed1"><span
              aria-hidden="true">&times;</span></button>
        </div>
        <div class="modal-body">
          <div class="row mb-3 w-100 py-0 justify-content-center mx-auto"><img id="prevNewMed" class="w-75 m-0" src="">
          </div>
          <form id="frmAddMed">
            <div class="row mb-3">
          ...
          <div class="progress mb-2 d-none" id="barNewMedCont">
            <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0"
              aria-valuemin="0" aria-valuemax="100" style="width: 0%" id="barNewMed"></div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary btn-block" data-dismiss="modal"
            id="btnCanNewMed0">Cancelar</button>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form id="frmPublish" class="d-none">
            ...
            <div class="from-row d-none" id="sendUptCont">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" id="inSendUpt">
                <label class="form-check-label" for="inSendUpt">Notificar actualización</label>
              </div>
              <div class="row my-2 d-none" id="uptDescCont">
                <div class="col">
                  <label>Descripción de la actualización</label>
                  <textarea class="form-control" id="inUptDesc" rows="3"></textarea>
                </div>
              </div>
            </div>
          </form>
          ...
          <div class="progress my-2 d-none" id="barPublishCont">
            <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%" id="barPublish"></div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-scckie btn-block" id="btnCnfPublish">Publicar</button>
          <button type="button" class="btn btn-secondary btn-block" data-dismiss="modal" id="btnCanPublish0">Cancelar</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="tbar tbar-right btn-toolbar mb-3" role="toolbar">
    <div class="btn-group-vertical mr-2 btn-group-lg" role="group">
      <button class="btn btn-scckie" data-toggle="modal" data-target="#mdlPlusSect"
        onclick="toAdd=docDat.cont.length-1;"><i class="fas fa-plus"></i></button>
      <button class="btn btn-scckie" data-toggle="modal" data-target="#mdlMedMan"><i class="fas fa-image"></i></button>
      <button class="btn btn-scckie" id="btnPrevCook"><i class="fas fa-eye"></i></button>
      <button class="btn btn-scckie" id="btnPrevMail"><i class="fas fa-envelope"></i></button>
      <button class="btn btn-scckie d-none" id="btnPrivate"><i class="fas fa-lock"></i></button>
      <button class="btn btn-scckie d-none" id="btnAprove"><i class="far fa-check-square"></i></button>
      <button class="btn btn-scckie d-none" id="btnPub" data-toggle="modal" data-target="#mdlPublish"><i
  ...
  <div class="container-fluid text-white"
    ...
    <div class="row justify-content-around">
      ...
      <div class="col-12 col-sm-9 col-md-6 col-xl-7 py-md-3 pl-md-3">
        ...
        <div id="cont" class="container-fluid mb-2 rounded-lg p-3" style="background-color:rgb(87, 35, 139);">
        </div>
        <div class="container-fluid mb-2 rounded-lg p-3" style="background-color:rgb(87, 35, 139);">
          <div class="row mb-2 px-2">
            <button class="btn btn-light btn-link-scckie ml-auto mr-2" id="btnEditJs"><i class="fas fa-edit"
                aria-hidden="true"></i></button>
            <button class="btn btn-light btn-link-scckie ml-auto mr-2 d-none" id="btnCheckJs"><i class="fas fa-check"
                aria-hidden="true"></i></button>
          </div>
          <div class="row mb-2">
            <div class="col">
              <label for="inJava">JavaScript</label>
              <textarea class="form-control" rows="8" id="inJava" readonly></textarea>
            </div>
          </div>
        </div>
